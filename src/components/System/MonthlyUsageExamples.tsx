...
export default function MonthlyUsageExamples() {
    return (
        <section className="w-full bg-black text-white py-10 px-6">
            <div className="w-10/12 mx-auto">
                {/* Heading */}

                <div className="rounded-2xl border border-white/10 bg-[#0b160e] p-6">
                    <p>Usage fees are pay-as-you-go - only charged when services are actively used. Voice AI is only charged when calls are answered (picked up), not for unanswered calls or voicemails. No hidden fees or minimums. </p>
                </div>
                <div className="text-left my-10">
                    <h2 className="text-3xl sm:text-4xl font-bold">
                        Typical Monthly Usage Examples:
                    </h2>
                </div>
                {/* Feature Cards Grid */}
